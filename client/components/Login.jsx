  ...
  return (
    <div>
      ...
      <div className="login-container flex flex-col justiy-center items-center">
        <div className="login-form w-3/5 border border-gray-300 rounded-lg pt-4 my-5 p-5">
          <h2 className="text-center font-bold text-4xl mt-10">Login</h2>
          <form className="text-xl" onSubmit={handleSubmit}>
            <div className="flex flex-col">
              <label className="block text-gray-800 mt-8">
                Email Address:
              </label>
              <input type="text" value={email} placeholder="teamAvatar@gmail.com" className="input-field rounded-md border-0 py-1 px-3 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 my-4 flex-grow" onChange={(e) => setEmail(e.target.value)} />
              <label className="block text-gray-800 w-1/3">
                Password:
              </label>
              <input type="password" value={password} placeholder="Enter your password" className="inline-block input-field rounded-md border-0 py-1 px-3 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 my-4 flex-grow"onChange={(e) => setPassword(e.target.value)} />
            </div>
