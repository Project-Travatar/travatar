      ...
      <div className="flex flex-col justify-center items-center">
        <div className="login-registration-form w-3/5 border border-transparent rounded-lg pt-4 mt-20 mb-5 p-10">
          ...
          <div className="oauth-container flex mt-20">
            <button type="button" onClick={signInWithGoogle} className="block text-white border border-slate-400 bg-slate-400 bg-opacity-60 hover:bg-slate-600 hover:text-slate-400 rounded-md py-2 rounded-full px-12 text-xl">Google Login</button>
            <button type="button" onClick={() => console.log('Facebook Oauth clicked!')} className="block text-white border border-slate-400 bg-slate-400 bg-opacity-60 hover:bg-slate-600 hover:text-slate-400 rounded-md py-2 ml-auto rounded-full px-12 text-xl">Facebook Login</button>
          </div>
        </div>
      </div>
    </div>
